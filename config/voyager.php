...
return [
    ...
    */
    ...
    'user' => [
        ...
        'default_role' => 'user',
        'default_personal_picture' => 'users/default.png',
        'redirect' => '/admin',
    ],
...
//            'App\Widgets\UserDimmer',
    ...
    */
    ...
    'googlemaps' => [
        ...
        'center' => [
            'lat' => env('GOOGLE_MAPS_DEFAULT_CENTER_LAT', '25.2048'),
            'lng' => env('GOOGLE_MAPS_DEFAULT_CENTER_LNG', '55.2708'),
        ],
